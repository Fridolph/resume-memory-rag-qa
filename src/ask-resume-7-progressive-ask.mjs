...
async function main() {
  ...
  console.log(`Progress events: ${progressLogs.length}\n`);
  ...
  printMatches('Cross-section support matches', result.crossSupportMatches);
  printMatches('Reserve evidence matches', result.reserveMatches);
